...
if __name__ == "__main__":
    try:
        try:
            ...
            from torch_ecg.torch_ecg.augmenters import AugmenterManager
            ...
            # in train.py
            from torch_ecg.models.loss import BCEWithLogitsWithClassWeightLoss, AsymmetricLoss
    ...
    try:
        ...
        from torch_ecg_bak.torch_ecg.augmenters import AugmenterManager
