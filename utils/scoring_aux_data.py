...
# dx_mapping_unscored.csv was updated in commit a5ed494 in the official_scoring_metric repo.,
# which however still has bugs I think
dx_mapping_unscored_pending = pd.read_csv(StringIO("""Dx,SNOMEDCTCode,Abbreviation,CPSC,CPSC_Extra,StPetersburg,PTB,PTB_XL,Georgia,Chapman_Shaoxing,Total,Var12
